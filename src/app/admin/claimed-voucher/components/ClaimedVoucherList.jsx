...
export default function ClaimedVoucherList() {
    ...
    async function searchData() {
      if(search == ''){
          try{
              const result = await axiosClientAPI.get(`claimed-voucher`, config)
              .then((response) => {
                  setData(response.data.data)
                  setPrevURL(response.data.links.prev)
                  setNextURL(response.data.links.next)
          ...
          try{
              const result = await axiosClientAPI.get(`claimed-voucher?search=${search}`, config)
              .then((response) => {
                  setData(response.data.data)
                  setPrevURL(response.data?.links?.prev)
                  setNextURL(response.data?.links?.next)
