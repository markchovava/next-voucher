  ...
  return (
    <>
        ...
        <>
            ...
            {/*  */}
            {isMsg == true &&
                <div className="w-[100%] mb-[1.5rem] flex items-center justify-center gap-5 text-lg text-green-700">
                    {message} 
            ...
            {/* ROW */}
            <div className='mx-auto w-[90%] flex justify-end items-center gap-5 pb-[2rem] '>
                { voucherExist ?
                ...
                <Link
                    href={`/admin/campaign-company/edit/${id}`}
