...
export default function ClaimList() {
    ...
    async function searchData() {
      if(search == ''){
          try{
              const result = await axiosClientAPI.get(`claim`, config)
              .then((response) => {
                  setData(response.data.data)
          ...
          try{
              const result = await axiosClientAPI.get(`claim?search=${search}`, config)
              .then((response) => {
                  setData(response.data.data)
    ...
    async function deleteData(id) {
      try{
        const result = await axiosClientAPI.delete(`claim/${id}`, config)
        .then((response) => {
          getData()
        })
      } catch (error) {
